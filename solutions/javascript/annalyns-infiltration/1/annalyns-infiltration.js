...
export function canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake) {
  if (knightIsAwake == false && prisonerIsAwake == false && archerIsAwake == false) {
    return false
  }
...
export function canSignalPrisoner(archerIsAwake, prisonerIsAwake) {
  if (archerIsAwake == false && prisonerIsAwake == false) {
    ...
    if (prisonerIsAwake == false && archerIsAwake) {
      return false
    }
  }
}
...
export function canFreePrisoner(
  ...
  if (petDogIsPresent) {
    ...
    if (prisonerIsAwake == false && archerIsAwake == false && knightIsAwake == false) {
      return false
    } else {
      if (prisonerIsAwake){
